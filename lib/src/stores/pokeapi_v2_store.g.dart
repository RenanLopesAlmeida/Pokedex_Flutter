...
mixin _$PokeApiV2Store on _PokeApiV2StoreBase, Store {
  ...
  @override
  Future<void> getInfoPokemon(String pokemonName) {
    return _$getInfoPokemonAsyncAction
        .run(() => super.getInfoPokemon(pokemonName));
  }
  ...
  @override
  Future<void> getInfoSpecie(int pokemonNumber) {
    return _$getInfoSpecieAsyncAction
        .run(() => super.getInfoSpecie(pokemonNumber));
  }
